...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--visualize-fovea', default=False, help='Whether to visualize fovea processed image')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/aa/frog/undergrad/datasets')
